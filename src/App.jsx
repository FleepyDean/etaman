...
// ==========================================
const USERS = [
  { username: 'adminjlnj', password: 'admin123', role: 'JLNJ_ADMIN', displayName: 'Admin JLNJ', pbtCode: null },
  { username: 'pbtmbjb',      password: 'pbt123', role: 'PBT', displayName: 'MBJB',       pbtCode: 'MBJB' },
  { username: 'pbtmbip',      password: 'pbt123', role: 'PBT', displayName: 'MBIP',       pbtCode: 'MBIP' },
  { username: 'pbtmbpg',      password: 'pbt123', role: 'PBT', displayName: 'MBPG',       pbtCode: 'MBPG' },
  { username: 'pbtmpbp',      password: 'pbt123', role: 'PBT', displayName: 'MPBP',       pbtCode: 'MPBP' },
  { username: 'pbtmpkluang',  password: 'pbt123', role: 'PBT', displayName: 'MPKluang',   pbtCode: 'MPKluang' },
  { username: 'pbtmpmuar',    password: 'pbt123', role: 'PBT', displayName: 'MPMuar',     pbtCode: 'MPMuar' },
  { username: 'pbtmpkulai',   password: 'pbt123', role: 'PBT', displayName: 'MPKulai',    pbtCode: 'MPKulai' },
  { username: 'pbtmpsegamat', password: 'pbt123', role: 'PBT', displayName: 'MPSegamat',  pbtCode: 'MPSegamat' },
  { username: 'pbtmppengerang', password: 'pbt123', role: 'PBT', displayName: 'MPPengerang', pbtCode: 'MPPengerang' },
  { username: 'pbtmppn',      password: 'pbt123', role: 'PBT', displayName: 'MPPn',       pbtCode: 'MPPn' },
  { username: 'pbtmdkt',      password: 'pbt123', role: 'PBT', displayName: 'MDKT',       pbtCode: 'MDKT' },
  { username: 'pbtmdlabis',   password: 'pbt123', role: 'PBT', displayName: 'MDLabis',    pbtCode: 'MDLabis' },
  { username: 'pbtmdmersing', password: 'pbt123', role: 'PBT', displayName: 'MDMersing',  pbtCode: 'MDMersing' },
  { username: 'pbtmdsr',      password: 'pbt123', role: 'PBT', displayName: 'MDSR',       pbtCode: 'MDSR' },
  { username: 'pbtmdtangkak', password: 'pbt123', role: 'PBT', displayName: 'MDTangkak',  pbtCode: 'MDTangkak' },
    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1 uppercase tracking-wider">Sistem Pengurusan Taman</p>
          <p className="text-slate-500 text-xs mt-1">Jabatan Perancangan Bandar Johor</p>
        </div>

        {/* Login Card */}
        <div className="bg-white p-8 shadow-2xl">
          <h2 className="text-lg font-semibold text-slate-800 mb-6 flex items-center gap-2">
            <Lock className="w-4 h-4 text-blue-600" /> Log Masuk
          </h2>
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 border border-slate-300 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm"
                ...
                >
                  {showPassword ? 'Sembunyikan' : 'Tunjuk'}
                </button>
              </div>
            </div>
        ...
        <p className="text-center text-slate-600 text-xs mt-6">
          Hak Cipta © 2026 Jabatan Perancangan Bandar Johor
        </p>
      </div>
    </div>
  );
    ...
    <div className="h-screen bg-slate-50 flex flex-col md:flex-row font-sans text-slate-800">
      ...
      <aside className="w-full md:w-64 md:fixed md:left-0 md:top-0 md:h-screen bg-slate-900 text-white flex flex-col border-r border-slate-800">
        ...
        <div className="p-4 border-t border-slate-800 space-y-3">
          ...
          <p className="text-[10px] text-slate-600 text-center">HAK CIPTA © 2026<br/>JABATAN PERANCANGAN BANDAR</p>
        </div>
      </aside>
                      ...
                      <tr key={taman.id} className={`hover:bg-slate-50 transition-colors ${selectedIds.includes(taman.id) ? 'bg-blue-50' : ''}`}>
                        ...
                        <td className="p-4 text-right">
                          <div className="flex justify-end gap-1">
                            ...
                            {(isAdmin || taman.PBT === currentUser.pbtCode) && (
